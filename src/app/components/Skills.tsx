      ...
      <section className="body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap -m-4">
            {/* Box 1 - HTML */}
            <div
              className="p-4 lg:w-1/3 md:w-1/2 w-full mb-6"
              data-aos="fade-up" // AOS animation for this box
            >
              <div className="flex rounded-lg h-full bg-white p-12 flex-col">
                <div className="flex items-center mb-5">
                  <div className="w-12 h-12 mr-4 inline-flex items-center justify-center rounded-full bg-yellow-500 text-white flex-shrink-0">
                    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
                      <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
                    </svg>
                  </div>
                  <h2 className="text-black text-2xl title-font font-medium">HTML</h2>
                </div>
            ...
            >
              <div className="flex rounded-lg h-full bg-white p-12 flex-col">
                <div className="flex items-center mb-5">
                  ...
                  <h2 className="text-black text-2xl title-font font-medium">CSS & Tailwind CSS</h2>
                </div>
                <div className="flex-grow">
                  <p className="leading-relaxed text-lg text-black">
            ...
            >
              <div className="flex rounded-lg h-full bg-white p-12 flex-col">
                <div className="flex items-center mb-5">
                  ...
                  <h2 className="text-black text-2xl title-font font-medium">TypeScript & Next.js</h2>
                </div>
                <div className="flex-grow">
                  <p className="leading-relaxed text-lg text-black">
